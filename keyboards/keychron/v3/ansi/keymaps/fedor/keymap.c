...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_tkl_ansi(
        ...
        _______,  _______,  _______,   X_EURO,  _______,  _______,  _______,    XP_UD,  _______,    XP_OD,  _______,  _______,  _______,    _______,  _______,  _______,  RGB_SPD,
        _______,    XP_AD,    XP_SS,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,              _______,
